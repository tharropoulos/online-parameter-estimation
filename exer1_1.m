...
mkdir(fullfile('figures','exer1','ucos','ab', 'eps'));
mkdir(fullfile('figures','exer1','ucos','ab', 'svg'));
mkdir(fullfile('figures','exer1','ucos','xxhat', 'eps'));
mkdir(fullfile('figures','exer1','ucos','xxhat', 'svg'));
mkdir(fullfile('figures','exer1','ucos','xdif', 'eps'));
mkdir(fullfile('figures','exer1','ucos','xdif', 'svg'));
...
%  dx =gradient_descent_dyn(t, odex, a, b, am, gamma, u);
...
for i = 1:length(am_options)
    ...
    saveas(fig1, fullfile('figures', 'exer1', 'ucos', 'xxhat', 'svg', sprintf('xxhat_am%d.svg', am_options(i))));
    saveas(fig1, fullfile('figures', 'exer1', 'ucos', 'xxhat', 'eps', sprintf('xxhat_am%d.eps', am_options(i))));
    
    saveas(fig2, fullfile('figures', 'exer1', 'ucos', 'ab', 'svg', sprintf('ab_am%d.svg', am_options(i))));
    saveas(fig2, fullfile('figures', 'exer1', 'ucos', 'ab', 'eps', sprintf('ab_am%d.eps', am_options(i))));

    saveas(fig3, fullfile('figures', 'exer1', 'ucos', 'xdif', 'svg', sprintf('xdif_am%d.svg', am_options(i))));
    saveas(fig3, fullfile('figures', 'exer1', 'ucos', 'xdif', 'eps', sprintf('xdif_am%d.eps', am_options(i))));
end
