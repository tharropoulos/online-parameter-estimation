...
mkdir(fullfile('figures','ucos','ab', 'eps'));
mkdir(fullfile('figures','ucos','ab', 'svg'));
mkdir(fullfile('figures','ucos','xxhat', 'eps'));
mkdir(fullfile('figures','ucos','xxhat', 'svg'));
mkdir(fullfile('figures','ucos','xdif', 'eps'));
mkdir(fullfile('figures','ucos','xdif', 'svg'));
...
for i = 1:length(am_options)
    ...
    saveas(fig1, fullfile('figures',  'ucos', 'xxhat', 'svg', sprintf('xxhat_am%d.svg', am_options(i))));
    saveas(fig1, fullfile('figures',  'ucos', 'xxhat', 'eps', sprintf('xxhat_am%d.eps', am_options(i))));
    
    saveas(fig2, fullfile('figures',  'ucos', 'ab', 'svg', sprintf('ab_am%d.svg', am_options(i))));
    saveas(fig2, fullfile('figures',  'ucos', 'ab', 'eps', sprintf('ab_am%d.eps', am_options(i))));

    saveas(fig3, fullfile('figures',  'ucos', 'xdif', 'svg', sprintf('xdif_am%d.svg', am_options(i))));
    saveas(fig3, fullfile('figures',  'ucos', 'xdif', 'eps', sprintf('xdif_am%d.eps', am_options(i))));
end
